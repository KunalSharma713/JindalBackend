...
const generateBarcodes = async (req, res) => {
    ...
    if (count < 1 || count > 100) { // Safety limit
    ...
    try {
        ...
        // We just need to create the documents.
        ...
        res.status(500).json({ message: 'Server error while generating barcodes.', error: error.message });
    }
};
