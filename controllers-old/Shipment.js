...
const createShipment = async (req, res, next) => {
    const { shipment_id, truckTypeId, destination_pin_code, destination_city,
        destination_state, userid, destination_country, actual_arrival_date, invoice_number } = req.body;
    ...
    try {
        ...
        if (slug === 'security_gaurd') {
            ...
            if (shipment_status) {
                ...
                filters = { ...filters, shipment_status: ['Confirmed', "GateIn", "Loading", "Loaded", "GateOut"] };
            }
        } else if (slug === "Munshi") {
            if (shipment_status) {
                filters = {
                ...
                filters = {
                    ...filters, shipment_status: ['Assigned', 'Confirmed', "GateIn", "Loading", "Loaded", "GateOut"]
                };
            }
...
module.exports = {
    createShipment, getShipmentDetails,
    getAllShipments, assignShipmentToCompany,
    assignDockNumber, getInTruck, ShipmentNumber, changeShipmentStatus, getAllTruckTypes, createTruckType
};
